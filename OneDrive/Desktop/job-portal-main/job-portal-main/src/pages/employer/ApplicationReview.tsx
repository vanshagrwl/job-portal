...
import { Application, applicationsAPI, jobsAPI, profileAPI, SeekerProfile, Profile } from '../../lib/api';
              ...
              >
                <GlassCard className="p-6">
                  ...
                  <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-4 mb-4">
                    <p className="text-green-400 text-sm font-medium mb-2">✓ Resume Attached</p>
                    <p className="text-gray-300 text-sm break-all font-mono">
                      {application.resume_url}
                    </p>
                  </div>
                  <p className="text-gray-400 text-sm italic mb-4">
                    File: <span className="text-white font-medium">{application.resume_url.split('/').pop()}</span>
                  </p>
                  <Button 
